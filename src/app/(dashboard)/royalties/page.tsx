...
import SplitChart from "@/components/royalties/SplitChart";
            ...
            {splits.map((split, index) => (
              <div key={split.id} className="flex items-center gap-4 px-4 py-3.5">
                <div
                  ...
                  style={{ backgroundColor: COLORS[index % COLORS.length] + "33", border: `1px solid ${COLORS[index % COLORS.length]}55` }}
                >
